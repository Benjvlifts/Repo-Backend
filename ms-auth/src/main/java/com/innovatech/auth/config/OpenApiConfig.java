...
/**
 * Configuración de OpenAPI/Swagger para ms-auth.
...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Innovatech - ms-auth API")
                        .description("Microservicio de Autenticación: registro, login, validación de tokens JWT y gestión de usuarios.")
                        .version("1.0.0")
                        .contact(new Contact()
